...
@section('content')
    ...
    <section class="content-header">
        @component('blog.admin.components.breadcrumb')
            @slot('parent') Редактирование пользователя@endslot
            @slot('title') Редактирование пользователя@endslot
            @slot('user') Главная@endslot
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="{{route('blog.admin.users.update',$user->id)}}" method="post" data-toggle="validator">
                        @method('PUT')
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="3" @php if ($role == 'user') echo 'selected' @endphp>Администратор</option>
                                    <option value="1" @php if ($role == 'user') echo 'selected' @endphp>Disabled</option>
                                </select>
                            </div>
                        </div>
